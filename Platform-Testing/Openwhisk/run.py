...
def parse_result(action_name, result ,radio):
    lines = result.split('\n')
    # parsed_results = []
    action_runs = []
    latencies = []
    ...
    for line in lines:
        ...
        with open("result.csv", "a+") as file:
            file.write('OpenWhisk' + ',' + action_name + ',' + str(pas["invokeTime"]) + ',' + str(pas["startTime"]) + ',' + str(
                pas["endTime"]) + ',' + str(radio) + ',' + str(schedule_latency) + '\n')
