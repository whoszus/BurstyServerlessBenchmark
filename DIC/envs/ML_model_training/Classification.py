...
def main():
    ...
    for i, (X_train_text, y_train) in enumerate(minibatch_iterators):
        ...
        for cls_name, cls in partial_fit_classifiers.items():
            ...
            with open("../Runtimes/ml-inference-with-data-RT/models/{}".format(cls_name), "wb") as model:
                pickle.dump(cls, model)

            with open("../Runtimes/ml-inference-with-data-RT/testData/{}".format(cls_name), "wb") as test_data:
